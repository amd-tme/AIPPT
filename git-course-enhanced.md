...
- Treat documentation with the same rigor as software source code
- Source Control: Store all files in Git
- Collaboration: Use branches and Pull Requests
- Automation: Automatically build and test docs
- Transparency: Maintain full history of changes
```
...
- Check for existing SSH keys (optional): `ls ~/.ssh`
- Generate a new SSH key: `ssh-keygen -t ed25519 -C "your_email@amd.com"`
...
- View your public key:
  ...
  - Open with: `notepad $env:USERPROFILE\.ssh\id_ed25519.pub`
- Add your key to GitHub:
  - Paste the `.pub` key into GitHub → Settings → SSH and GPG keys
```
...
- Repository (Repo): Project folder with all files and change history.
- Commit: Snapshot of changes at a specific time, like "Save As...".
- Branch: Parallel repo version for safe work without affecting main project.
- Merge: Combining changes from one branch into another.
- Pull Request (PR): Request to merge changes; includes review and discussion.
```
...
- Pull Requests: View changes line by line for collaboration
```
...
- Fork: Create a copy of the repo in your GitHub account
- Clone: Download the repo to your machine
- Branch: Create a safe space for your edits
- Edit: Write content in VS Code
...
- 5 essential commands for 90% of tasks:
  - `git clone`
  - `git checkout -b`
  - `git add .`
  - `git commit -m`
...
- **Markdown (.md)**
  - Simple, readable, ubiquitous
  - Best for: READMEs, simple docs, comments

- **reStructuredText (.rst)**
  - Powerful, extensible, standard for Sphinx
...
- Pull Requests facilitate conversation, not just code merging
- Files Changed: View a "diff" to see additions or deletions
- Inline Comments: Ask questions or suggest edits on specific lines
- Approvals: Require peer sign-off before publishing
```
...
```markdown
## Docs-as-Code Overview

- Docs-as-Code integrates software development tools into documentation for improved collaboration and quality control.
- Git offers version history and a safety net to prevent data loss.
- GitHub serves as a collaboration hub for change reviews and task management.
- Automation manages routine tasks like link checking and HTML building, allowing focus on writing.
```
...
- Read Sphinx and Markdown documentation for syntax review
- Work through example repositories (details on next slide)
- Install Git and VS Code on your workstation
...
- GitHub: [AMD-melliott](https://github.com/AMD-melliott)
- Email: melliott@amd.com
```
